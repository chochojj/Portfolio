...
const projectData: Project[] = [
  {
    ...
    term: "3 일",
    content:
      "반응형 웹으로 제작되었으며 useEffect와 timeout을 이용하여 간단한 타이밍 애니메이션과 호버 애니메이션을 적용해 동적인 효과를 주었습니다. 프로젝트 리스트를 통해 간단한 프로젝트 이력을 확인할 수 있고 팝업 모달으로 상세 프로젝트 내역을 확인할 수 있습니다 또한, 프로젝트 데이터를 별도의 객체로 관리하고 grid 레이아웃을 활용하여 추후 작업물이 추가되어도 CSS를 크게 수정하지 않아도 되는 장점이 있습니다. 이를 통해 유연하게 프로젝트를 관리할 수 있습니다.",
    role: ["반응형 웹", "타이핑 애니메이션", "프로젝트 상세 모달"],
    skill: [
      "React",
      "Nextjs",
      "TypeScript",
  ...
  },
  {
    ...
    role: ['프론트엔드 신규 개발', '화면 유지 보수','신규 기술 전환','공통 컴포넌트 설계', '웹 접근성', '최적화' ,'공통 컴포넌트 설계','데이터 시각화'],
    skill: [
      "React",
      "Nextjs",
      "TypeScript",
  ...
  },
  {
    ...
    role: ["Todo CRUD", "간단한 일기 CRUD", "페이지 이동","로컬 스토리지 데이터 저장"],
